        ...
        {data.map((product) => (
          <div key={product.id} className="card d-flex  justify-content-center">
            <div className="cart-image d-flex  justify-content-center">
              <img
                src={
                  product.images === "coffee.png" || product.image
                    ? "https://www.motorcyclevalley.com/photo/thumb/New-Suzuki-Gixxer-Carburetor.jpg"
                    : product.images
                }
                alt="#"
                onError={({ currentTarget }) => {
                  currentTarget.onError = null;
                  currentTarget.src =
                    "https://c.tenor.com/haruxnBh-T4AAAAC/mouse-mini.gif";
                }}
              />
            ...
            <div className="card-description">
              ...
              <div className="d-flex justify-content-between w-100">
                <button
                  ...
                  style={{ color: props.mode === "dark" ? "gray" : "white" }}
                >
                  <span>
                    <i className="fa-solid fa-bag-shopping pe-2"></i>Cart{" "}
                  </span>
                </button>
                <button
                  type="button"
                ...
                >
                  <span>
                    <i className="fa-solid fa-heart pe-2"></i>Wishlist
                  </span>
                </button>
              </div>
            </div>
